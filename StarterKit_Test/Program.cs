...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "StarterKit", Version = "v1" });
...
Extensions.ModuleName = "StarterKit";
...
//    app.UseSwagger();
//    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "StarterKit API v1"));
//}
